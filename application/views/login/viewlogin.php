...
<?php echo form_open('login/cekuser')?>
<body>

<center><div class="pull-center image"><img src="<?php echo base_url()?>temp/dist/img/hh.jpg" alt="User Image" align="center" class="img-circle" style="width: 30%; height: auto"></div></center>
